...
class mapdb
{
    ...
    {
        return [ "satuan_pendidikan" => "AllPT"];
    }
    ...
    private function peta_kolom()
    {
        $this->peta["field"] = array    (   /* tabel Referensi */
                                            ...
                                            "AllPT"                                     => array("id" => "null", "kode_perguruan_tinggi" => "kodept", "nama_perguruan_tinggi" => "namapt", "namasingkat" => "kotapt", "id_perguruan_tinggi"=>"guid"),
    ...
    private function peta_tabel()
    {
        $this->peta["table"] = array (  /* tabel Referensi */
                                        ...
                                        "AllPT"               => array("nama" => "pt_perguruantinggi", "filter" => ""),
                                    );
    }
    ...
    private function peta_ekstrak()
    {
        $this->peta["extract"]  = array (  "dosen_pt"           =>  array(  "table"                 => "ak_penugasan",
                                            ...
                                            "AllPT"             =>  array(  "table"                 => "pt_perguruantinggi",
                                                                            "uniquefield"           => array("id_perguruan_tinggi", "guid"),
                                                                            "istahunakademikkrs"    => false,
                                                                            "filtertahunakademik"   => ""
                                                                        ),
    ...
    private function peta_pk()
    {
        $this->peta["pk"]   = array (   /* tabel Referensi */
                                        ...
                                        "AllPT institusi"                           => array("id_perguruan_tinggi", "idkonfigurasi"),
                                        "AllPT"                                     => array("kode_perguruan_tinggi", "kodept"),
    ...
    private function peta_guid()
    {
        $this->peta["guid"] = array (   /* tabel Referensi tidak memerlukan mapping ini */
                                        "AllPT institusi"               => array(   array(           "guid"                          => array("id_perguruan_tinggi", "k.guid"), 
                                                                                                        "variable"                      => array("kode_perguruan_tinggi", "k.kodept"), 
